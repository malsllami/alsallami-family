...
function setupBaseTree() {
  ...
  var baseNodes = [
    { id:'N000', member:'', name:'صاحب العفريتي', parent:'',    parentName:'',              gen:1, path:'صاحب العفريتي',                  alive:'متوفى' },
    { id:'N001', member:'', name:'أحمد',           parent:'N000', parentName:'صاحب العفريتي', gen:2, path:'صاحب العفريتي ← أحمد',          alive:'متوفى' },
    { id:'N002', member:'', name:'شامي',            parent:'N001', parentName:'أحمد',          gen:3, path:'صاحب العفريتي ← أحمد ← شامي',   alive:'متوفى' },
    { id:'N003', member:'', name:'صاحب',            parent:'N001', parentName:'أحمد',          gen:3, path:'صاحب العفريتي ← أحمد ← صاحب',  alive:'متوفى' },
    { id:'N004', member:'', name:'يحيى',            parent:'N001', parentName:'أحمد',          gen:3, path:'صاحب العفريتي ← أحمد ← يحيى',  alive:'متوفى' },
    { id:'N005', member:'', name:'علي',             parent:'N001', parentName:'أحمد',          gen:3, path:'صاحب العفريتي ← أحمد ← علي',   alive:'متوفى' },
    { id:'N006', member:'', name:'إبراهيم',         parent:'N001', parentName:'أحمد',          gen:3, path:'صاحب العفريتي ← أحمد ← إبراهيم', alive:'متوفى' },
  ];
