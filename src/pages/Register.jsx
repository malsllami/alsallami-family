            ...
            {successInfo && messageType === 'success' ? (
              <>
                <a
                  ...
                  className="flex items-center justify-center gap-2.5 w-full py-3.5 rounded-2xl font-nav font-bold text-sm transition-all hover:opacity-90"
                  ...
                  تواصل مع المدير عبر واتساب لاعتماد الطلب
                </a>
                <button type="button" onClick={() => navigate('/login')}
                  className="w-full py-3 font-nav text-sm rounded-2xl transition-all hover:opacity-80"
                  style={{ border: '1px solid rgba(255,255,255,0.1)', color: 'rgba(255,255,255,0.72)', background: 'rgba(255,255,255,0.04)' }}>
