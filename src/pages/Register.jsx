...
export default function Register() {
  ...
  const [branches, setBranches] = useState([]);  // ← من API
  ...
  // إصلاح: إزالة formData من dependencies
  useEffect(() => {
    if (selectedFather) {
      setFormData(prev => ({
        ...prev,
  ...
  }, [selectedFather?.id, formData.firstName, formData.nationalId, formData.birthDate]);
